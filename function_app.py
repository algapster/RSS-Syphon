...
def timer_trigger(myTimer: func.TimerRequest) -> None:
    ...
    slacker.send_message("news", config.slack_params_dict, news_matched, news_feed_errors, update_keywords)
    ...
    slacker.send_message("cve", config.slack_params_dict, cve_matched, cve_feed_errors, update_keywords)
